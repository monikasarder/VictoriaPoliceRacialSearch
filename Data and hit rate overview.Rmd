...
of.interest <- c("Year", "Ethnic.appearance.abridged","Gender", "Area.type", "Unit.type", "Contact.Type" ,"Rank.of.Member", "Found",
...
trend <- dat %>%
  mutate(Ethnic.appearance = fct_infreq(Ethnic.appearance.abridged))%>%
